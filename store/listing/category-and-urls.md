# Categorie, taal en URL's

Vul deze velden in het tabblad **Store listing** in.
...
## Privacybeleid-URL online zetten
...
Publiceer je in de EU, dan vraagt Google om je **trader-status**. Kies:
- **Non-trader** als je dit als hobby/persoonlijk project uitgeeft (adresgegevens
  worden dan niet openbaar). Let op: bij een non-trader-verklaring kun je later
  problemen krijgen als blijkt dat je het commercieel aanbiedt.
- **Trader** als je het beroepsmatig/commercieel aanbiedt. Google toont dan
  bedrijfs-/contactgegevens op de listing.

Bepaal dit zelf; bij twijfel is *non-trader* voor een gratis hobby-extensie de
gebruikelijke keuze.
